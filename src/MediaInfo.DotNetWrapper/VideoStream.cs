...
namespace MediaInfo.DotNetWrapper
{
    public class VideoStream : LanguageMediaStream
    {
        ...
        {
            string strCodec = mediaInfo.Get(StreamKind.Video, StreamPosition, "Format").ToUpper();
            string strCodecVer = mediaInfo.Get(StreamKind.Video, StreamPosition, "Format_Version").ToUpper();
